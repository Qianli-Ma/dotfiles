...
plugins=(git command-not-found extract macos zsh-autosuggestions zsh-syntax-highlighting zsh-completions)
...
autoload -Uz add-zsh-hook
  [ -f /opt/homebrew/etc/profile.d/autojump.sh ] && export PATH="/opt/homebrew/bin:$PATH"
...
# Flutter
export PATH="$PATH:/Users/QianliMa-MBP14/flutter/bin"
eval "$(/Users/QianliMa-MBP14/.local/bin/mise activate zsh)"
